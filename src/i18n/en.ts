export default {
    ...
    SINAL_CIRCUITO_ONLINE: 'So, I checked here and your circuit is working. The circuit that is presenting the problem is the {0} ? If so, come on, click on RESTART and I will execute the command on your circuit! But if you want to change a configuration or open a ticket, please click on OPEN TICKET.',
    ...
    REINICIAR: 'Restart',
    ESTA_OK: 'It is ok!',
    PRIMEIRA_PERGUNTA: 'Hello, I am AVO your virtual assistant. I will try to help you.But first, take away this doubt, is your problem slow or intermittent?',
    SIM: 'Yes',
    NAO: 'No',
