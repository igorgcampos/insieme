export default {
    ...
    SINAL_CIRCUITO_ONLINE: 'Ok, let´s go! Click on RESTART and I will execute the command on your circuit! But if you want to change a configuration or open a ticket, please click on OPEN TICKET.',
    SINAL_CIRCUITO_ONLINE_2: 'Done, I restarted your circuit! Tell me if your circuit is ok or if you still need to open a ticket.',
    SINAL_CIRCUITO_OFFLINE: 'I verify that your circuit is not responding. Would you like to restart it now?',
    CONFIRMAR_SELECAO_CIRCUITO: 'I checked here and your circuit is working. The circuit that is presenting the problem is the {0} ?',
    REINICIAR: 'Restart',
    ESTA_OK: 'It is ok!',
    PRIMEIRA_PERGUNTA: 'Hello, I am AVO your virtual assistant. I will try to help you.But first, take away a doubt: Is your problem slow or intermittent?',
    SIM: 'Yes',
    NAO: 'No',
