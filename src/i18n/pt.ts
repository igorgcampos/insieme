export default {
    ...
    V_2_8_0: '- Uma nova tela de boletim de medições foi disponibilizada para que o usuário visualize os valores mensais a serem cobrados por cada circuito, incluindo serviços externos realizados em cada um deles.<br>- A tela de disponibilidade de circuitos foi implementada para que o usuário visualize o tempo mensal em que cada circuitos ficou offline para fins de comparação dos níveis de SLA definidos.<br>- O Insieme agora gerencia contratos de diversos países e não apenas os do Brasil <br>- Os produtos StarLink agora são suportados pelo Insieme, exibindo informações de consumo, status online/offline e um dashboard com diversas métricas de desempenho.',
    ...
    DETALHES_DISPONIBILIDADE: 'Detalhes da disponibilidade da rede',
    DISPONIBILIDADE_CIRCUITO: 'Disponibilidade por circuito',
    CIRCUITOS_ATIVOS: 'Circuitos ativos',
    TOTAL_HORAS_PREVISTAS: 'Total de horas previstas',
    TOTAL_HORAS_PERDIDAS: 'Total de horas perdidas',
    DPN_REDE: 'DPN da rede',
    VER_DETALHES_DISPONIBILIDADE: 'Clique para ver mais detalhes e disponibilidades por circuito',
    TEMPO_TOTAL_REPARO: 'Tempo total de reparo (horas)',

    LATENCIA_ATUAL: 'Latência atual',
    TAXA_DOWNLOAD_ATUAL: 'Taxa de download atual',
    TAXA_UPLOAD_ATUAL: 'Taxa de upload atual',
    TAXA_PERDA_PACOTES_ATUAL: 'Perda de pacotes atual',
    QUALIDADE_SINAL: 'Qualidade do sinal',
    TEMPO_OBSTRUCAO_ATUAL: 'Tempo de obstrução atual',
    VISADA_OBSTRUIDA: 'Visada obstruída',
    LATENCIA: 'Latência (ms)',
    TAXA_DOWNLOAD: 'Taxa de download (Mbps)',
    TAXA_UPLOAD: 'Taxa de upload (Mbps)',
    TAXA_PERDA_PACOTES: 'Perda de pacotes (%)',
    TEMPO_OBSTRUCAO: 'Tempo de obstrução (%)',
    PLANO: 'Plano',
    AVISO_CONSUMO: 'O rastreamento do uso de dados não é imediato e pode ter atraso de 24 horas ou mais.',
    ...
    ANO: 'Ano',
    NENHUM_RELATORIO: 'Nenhum relatório encontrado',
    RELATORIO_MEDIO_MES: 'Relatório de disponibilidade média por mês (%)',
    JANEIRO: 'Janeiro',
    FEVEREIRO: 'Fevereiro',
    MARCO: 'Março',
    ABRIL: 'Abril',
    ...
    SEM_LOCALIZACAO: 'Este dispositivo não apresenta coordenadas geográficas',
    ...
    OPERADORA: 'Operadora',
    ENVIADO: 'Enviado',
    EXIBIR_DISPOSITIVOS: 'Exibir dispositivos',
    DISPOSITIVOS: 'Dispositivos',
    DISPOSITIVO_SEM_LOCALIZACAO: 'Dispositivo sem localização',
    SELECIONE_PERIODO: 'Selecione o periodo',
    INICIO: 'Inicio',
    FIM: 'Fim',
}