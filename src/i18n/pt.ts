export default {
    ...
    V_2_6_0: 'O processo de restart de circuitos passou a ser realizado de forma independente da tela principal, permitindo que o usuário possa realizar mais de um restart ou fazer outras operações na tela principal do Insieme.',
